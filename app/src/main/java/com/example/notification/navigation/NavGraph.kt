...
import com.example.notification.screen.DetailsScreen
import com.example.notification.screen.MainScreen
...
fun SetupNavGraph(
    ...
    NavHost(
        ...
        composable(
            ...
            arguments?.getString(MY_ARG)?.let { message -> DetailsScreen(message = message) }
        }
    }
}